    ...
    def model_simplified(
        ...
        with pyro.poutine.scale(scale=0.01 * x.shape[0] / self.n_obs):
            if corrected_rate:
                ...
                simplified_model(x, ind_x, library, y, batch_index, cat_covs, x_n, distances_n, n_obs, kl_weight)
...
class RESOLVAEGuide(PyroModule):
    ...
    def guide_simplified(
        ...
        with pyro.poutine.scale(scale=x.shape[0] / self.n_obs):
            simplified_guide(x, ind_x, library, y, batch_index, cat_covs, x_n, distances_n, n_obs, kl_weight)
