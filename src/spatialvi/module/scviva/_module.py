...
from spatialvi.model.scviva._components import DirichletDecoder, Encoder, NicheDecoder
from spatialvi.model.scviva._constants import SCVIVA_MODULE_KEYS, SCVIVA_REGISTRY_KEYS
...
class nicheVAE(VAE):
    ...
    def loss(
        ...
        z1_mean_niche = tensors[SCVIVA_REGISTRY_KEYS.Z1_MEAN_CT_KEY]  # batch times cell_types times n_latent
