...
def plot_connectivity_distribution(csr_matrix: csr_matrix) -> None:
...
@dependencies("matplotlib")
def plot_niche_de_decision_boundary(
    ...
    ----------
    results
        Fitted :class:`~scviva.model.utils._scviva_de.DifferentialExpressionResults`.
    X
